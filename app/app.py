...
from app.database import insert_cliente, insert_venda, get_clientes
...
def main():
    ...
    if escolha == "Inserir Cliente":
        ...
        with st.form("form_cliente"):
            ...
            area_culturas = st.number_input("Área das Culturas", min_value=0.0, step=0.1)
        ...
        cliente_opcoes = {f"{cliente[1]} ({cliente[0]})": cliente[0] for cliente in clientes}
