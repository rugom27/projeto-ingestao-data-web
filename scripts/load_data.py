...
from application.database import insert_cliente, insert_venda
...
def load_clientes(sheet_name="clientes_processado"):
    ...
    df.columns = [
        ...
        "Cultura",
        "Área das culturas",
        "Responsável_principal",
        "Responsável_secundário",
        "Distrito",
        "latitude",
        "longitude",
    ]

    # Remover duplicados com base na coluna "Numero Cliente"
    df = df.drop_duplicates(subset=["Numero Cliente"])
    ...
    for _, row in df.iterrows():
        ...
        try:
            ...
            print(f"Cliente já existe: {cliente_data['numero_cliente']}")
...
def load_vendas(sheet_name="vendas_2023_2024_processado"):
    ...
    # Remover linhas onde numero_de_cliente está vazio ou nulo
    df = df.dropna(subset=["numero_de_cliente"])
    ...
    for _, row in df.iterrows():
        ...
        try:
            ...
            print(f"Erro ao inserir venda: {e}. Dados: {venda_data}")
